    ...
    <>
      <div className="gallery grid grid-cols-4 auto-rows-14 gap-2 max-w-5xl m-auto">
        {images.map(({ id, fluid }, index) => (
          <div onClick={(e) => handleOpen(e, index)} key={`div-${id}`}>
      ...
      /> */}
      {showLightbox && (
        <div className="fixed top-0 left-0 w-screen h-screen bg-opacity-80 bg-gray-700 flex justify-center items-center" onClick={handleClose}>
